...
Offline: clone [natl](https://github.com/natl-dev/natl) and set
...
CI: copy [`examples/.github/workflows/natl.yml`](https://github.com/natl-dev/natl/blob/main/examples/.github/workflows/natl.yml)
